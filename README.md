...
<!-- ANIMATED TYPING -->
<p align="center">
  <img src="https://readme-typing-svg.herokuapp.com?color=DC2626&size=26&center=true&vCenter=true&width=900&lines=🚀+A+PASSIONATE+CODER;💡+Problem+Solver+%26+Tech+Explorer;⚡+Building+Real-World+Projects;🚑+Creator+of+The_Helper;🌱+Always+Learning+New+Technologies" />
</p>
...
<!--
  Tip: to make the snake itself red/white, add a "snake.yml" GitHub Action
  to your profile repo and set `dark_color_scheme: black,#7F1D1D,#DC2626,#FCA5A5,#FFFFFF`
